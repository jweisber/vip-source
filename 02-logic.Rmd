...
```{r laplace, echo=FALSE, fig.margin=TRUE, fig.cap="Pierre Simone Laplace (1749--1827) [developed a formula](https://en.wikipedia.org/wiki/Sunrise_problem) for calculating this number exactly. We'll learn how to do similar calculations in the coming chapters."}
