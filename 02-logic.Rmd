...
```{r echo=FALSE, fig.cap="Leonhard Euler ($1707$-–$1783$)", fig.margin = TRUE}
...
(ref:laplacecap) Pierre Simone Laplace ($1749$--$1827$) developed [a formula](https://bit.ly/2mU9WgW) for calculating this number exactly. We'll learn how to do similar calculations in the coming chapters.
