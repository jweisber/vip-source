...
`r newthought("[Earlier][Lessons Learned] we talked")` about how some pairs of propositions are mutually exclusive: if one of them is true, the other must be false. For example:
