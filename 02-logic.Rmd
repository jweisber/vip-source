...
These are called ***Euler diagrams***, after the mathematician Leonhard Euler (prounounced *oiler*).[^eulernote] You may have seen Venn diagrams before, which are very similar. But in Euler diagrams the circles don't have to overlap.
