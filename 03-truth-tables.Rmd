...
Sometimes we also need parentheses to avoid ambiguity. Consider this example from arithmetic:
$$ 4 \div 2 \times 2 = 1. $$
...
In logic we also use parentheses to prevent ambiguity. Consider:
$$ A \vee B \wedge C. $$
