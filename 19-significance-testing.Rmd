...
```{r fig.margin=TRUE, fig.cap="The famous normal distribution, sometimes called the \"bell curve\""}
...
```{r fig.margin=TRUE, fig.cap="Bell curves with various standard deviations, making them wider or thinner"}
