...
`r newthought("It all hangs")` on whether the sex of each baby is "independent" of the others. Two events are ***independent*** when the outcome of one doesn't change the probability of the other.
...
`r newthought("Flips of an ordinary coin")` are also independent. Even if you get ten heads in a row, the eleventh toss is still $50$-$50$. If it's *really* an ordinary coin, the ten heads in a row was just a coincidence.
...
`r newthought("At this point")` you may have a nagging thought at the back of your mind. If we flipped a coin 100 times and it landed heads every time, wouldn't we conclude the next toss will probably land heads? How could that be a mistake?!
