...
```{r fig.cap="Bank tellers and feminist bank tellers"}
...
```{r fig.margin=TRUE, fig.cap="Frank Ramsey first noticed the connection between Dutch books and the laws of probability in the 1920s."}
knitr::include_graphics("img/marg_fig.png")
```
```{r fig.margin=TRUE, fig.cap="Bruno de Finetti first proved that the laws of probability are the only safegaurd against Dutch books in the 1930s."}
knitr::include_graphics("img/marg_fig.png")
```
