...
```{r echo=FALSE, cache=TRUE, fig.margin=TRUE, fig.cap="The hammer/feather experiment was performed on the moon in 1971. See the [full video here](https://bit.ly/1KLQzOB)"}
...
```{r echo=FALSE, cache=TRUE, fig.margin=TRUE, fig.cap="It's also been performed in vacuum chambers here on earth. A beautifully filmed example is [available on YouTube](https://bit.ly/10hw8mP), courtesy of the BBC."}
if (knitr:::is_latex_output()) {
