...
If there are white ravens in the world, they might be limited to certain locales.^[In fact there are white ravens, [especially in one part of Vancouver Island](https://vancouversun.com/news/local-news/rare-white-raven-spotted-on-vancouver-island).] So the fact we're only observing ravens in our part of the world could make a big difference to what we find. It matters whether your sample really is random.
...
Another common form of inductive argument we met in [Chapter 2][Logic] was Inference to the Best Explanation, known as *IBE* for short. An example:
...
```{r fig.margin=TRUE, fig.cap="The hammer/feather experiment performed on the moon in 1971"}
knitr::include_graphics("img/marg_fig.png")
```

```{r fig.margin=TRUE, fig.cap="The hammer/feather experiment performed in a vaccuum chamber on Earth"}
knitr::include_graphics("img/marg_fig.png")
```
