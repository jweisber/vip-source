...
```{r taxigrid, echo=FALSE, fig.margin=TRUE, fig.cap="The taxicab problem. There are $85$ blue cabs, $15$ green. The dashed region indicates those cabs the witness identifies as \"blue\". It includes $80\\%$ of the blue cabs ($12$), and only $20\\%$ of the green ones ($17$). Yet it includes more green cabs than blue."}
...
Hence the quote that opens [Chapter 1][The Monty Hall Problem] of this book: "in no other branch of mathematics is it so easy for experts to blunder as in probability theory."
