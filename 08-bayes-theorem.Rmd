...
This proves that Bayes' theorem is correct. But it doesn't really give us an intuitive or visual way of thinking about it. We'll come back to an intuitive interpretation soon, in [Chapter 10][Inference to the Best Explanation]. In the meantime, our taxicab diagram is one way to think about Bayes' theorem visually.
...
1. Start with the definition of conditional probability, visualized in [Chapter 6][Calculating Conditional Probability].
2. Apply the General Multiplication Rule, visualized in [Chapter 7][The General Multiplication Rule].
...
But in any case, Bayes' theorem comes up so often that it's good to memorize the formula itself. For which the following visualization is probably about as helpful as it gets:
