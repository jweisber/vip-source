...
```{r echo=FALSE, fig.margin = TRUE, fig.cap="Psychologists Daniel Kahneman and Amos Tversky"}
...
```{r echo=FALSE, fig.cap="Green cab/blue cab"}
...
```{r echo=FALSE, fig.cap="Bayes' theorem displayed at the offices of HP Autonomy in Cambridge, UK"}
