...
```{r fig.margin=TRUE, fig.cap="Frank Ramsey (1903--1930). Sadly Ramsey died very young, at the age of 26, before his discovery could become widely known. Luckily the idea was rediscovered by economists and statisticians in the 1940's and 1950's."}
...
```{r fig.margin=TRUE, fig.cap="The best possible gamble"}
knitr::include_graphics("img/marg_fig.png")
```
```{r fig.margin=TRUE, fig.cap="The worst possible gamble"}
knitr::include_graphics("img/marg_fig.png")
```
```{r fig.margin=TRUE, fig.cap="A gamble of intermediate value"}
knitr::include_graphics("img/marg_fig.png")
```
...
```{r fig.cap="The diminishing value of additional money"}
