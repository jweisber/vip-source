...
```{r fig.cap="A proposition and its negation"}
...
```{r fig.cap="The General Addition Rule in an Euler diagram"}
knitr::include_graphics("img/fig.png")
```
...
```{r fig.cap="The General Addition Rule in a tree diagram"}
knitr::include_graphics("img/fig.png")
```
...
```{r fig.cap="Tree diagram for a simple urn problem"}
knitr::include_graphics("img/fig.png")
```
...
```{r fig.margin=TRUE, fig.cap="Pierre Simone Laplace (1749--1827)"}
