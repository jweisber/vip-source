...
```{r fig.show='hold', fig.margin=TRUE, fig.cap="Conditional probability in a fair die roll"}
...
```{r fig.cap="Conditional probability is the size of the $A \\wedge B$ region compared to the entire $B$ region."}
...
```{r fig.cap="Tree diagram for an urn problem"}
df_nodes <- rbind(
