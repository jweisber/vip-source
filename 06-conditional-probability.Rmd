...
```{r echo=FALSE, cache=TRUE, fig.show='hold', fig.margin=TRUE, fig.cap="Conditional probability in a fair die roll"}
...
```{r echo=FALSE, cache=TRUE, fig.cap="Conditional probability is the size of the $A \\wedge B$ region compared to the entire $B$ region."}
...
```{r echo=FALSE, cache=TRUE, fig.cap="Tree diagram for an urn problem"}
df_nodes <- rbind(
...
#. Answer each of the following:
    ...
    a.  What is the probability of rolling a low number (1, 2, or 3) given that you roll an even number.
    #.  On a fair, eight-sided die, what is the probability of rolling an even number given that you roll a high number (5, 6, 7, or 8)?
...
#. Is the following statement true or false: if $A$ and $B$ are mutually exclusive, then $Pr(A \vee B \given C) = Pr(A \given C) + Pr(B \given C)$. Justify your answer. 
    ...
    Note that this exercise is about determining whether the [Addition Rule][Adding Probabilities] also applies to conditional probability.
