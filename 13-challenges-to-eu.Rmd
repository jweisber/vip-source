...
```{r echo=FALSE, fig.margin=TRUE, fig.cap="Maurice Allais"}
knitr::include_graphics("img/marg_fig.png")
```
```{r echo=FALSE, fig.margin=TRUE, fig.cap="Leonard Savage"}
knitr::include_graphics("img/marg_fig.png")
```
...
```{r echo=FALSE, fig.margin=TRUE, fig.cap="Daniel Ellsberg (b. 1931). Ellsberg is most famous as the leaker of the Pentagon Papers, depicted in the 2017 movie *The Post*."}
knitr::include_graphics("img/marg_fig.png")
```
