...
```{r echo=FALSE, fig.margin=TRUE, fig.cap="Daniel Ellsberg (b. 1931) is most famous as the leaker of [the Pentagon Papers](https://en.wikipedia.org/wiki/Pentagon_Papers). The 2017 movie [*The Post*](https://en.wikipedia.org/wiki/The_Post_(film)) tells that story, with Ellsberg portrayed by actor Matthew Rhys. (Photograph by Bernd Gross)."}
