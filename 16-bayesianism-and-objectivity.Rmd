# Bayesianism & Objectivity

For Bayesians, probabilities are beliefs. When I say it'll probably rain today, I'm telling you something about my level of confidence. I mean that I'm over $50\%$ confident it will rain today. 

But how can we quantify something as personal as confidence? Bayesians quantify confidence using the same basic idea we used for utility. They look at people's choices, at what risks they're willing to accept.
...
We have to be careful though. This technique only works if the subject's betting rates follow the familiar rules of probability. If my betting rate for rain tomorrow is $3/10$, you might expect my betting rate for no rain to be $7/10$. But people don't always follow the laws of probability, just as they don't always follow the expected value rule. The taxicab problem from [Chapter 8][Bayes' Theorem] illustrates one way people commonly violate the rules of probability.

`r newthought("This point raises a new question,")` one of central importance to the Bayesian way of thinking.


## Dutch Books

The critics still aren't happy. "Ok," they concede, "maybe personal probabilities can be quantified using betting rates. But a person's betting rates may not obey the laws of probability. What's to stop someone being, say, $9/10$ confident it will rain tomorrow but also $9/10$ confident it won't? How do we enforce laws of probability like
$$\p(A) = 1 - \p(\neg A)$$
