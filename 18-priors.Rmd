...
```{r echo=FALSE, fig.margin=TRUE, fig.cap="The continuous roulette wheel"}
...
```{r echo=FALSE, fig.margin=TRUE, fig.cap="Some history on Bertrand's paradox: Lorem ipsum dolor sit amet..."}
knitr::include_graphics("img/marg_fig.png")
```
