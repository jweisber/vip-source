...
Others think the paradox shows that the whole idea of "prior" and "posterior" probabilities is a mistake. Frequentists say that probability isn't a matter of personal beliefs, and there are objective rules for using probability to evaluate hypotheses. Conditionalization is just the wrong way to go about it.
