...
```{r fig.cap="Expected value as area"}
...
```{r fig.margin = TRUE, fig.cap="A gamble with one negative payoff"}
...
```{r fig.margin = TRUE, fig.cap="A gamble with four possible outcomes"}
knitr::include_graphics("img/marg_fig.png")
```
