...
`r newthought("Most")` casino games have more than two possible payoffs. For that matter, most decisions in life have more than two possible outcomes. If you buy insurance for your phone, it could end up saving you $\$0$, or it could save you $\$100$, or it might save you $\$150$, etc.
...
Not quite. Consider a similar example, where this kind of reasoning would be disastrous. You're deciding whether to study for your midterm, and let's imagine your rich uncle has promised to give you $\$100$ if you get an A. The catch is that, to study, you'll have to miss a shift at work and lose $\$50$. You draw up a decision table, based on whether you get an A or not:
