...
```{r echo=FALSE, fig.margin=TRUE, fig.cap="Nicolaus Bernoulli"}
knitr::include_graphics("img/marg_fig.png")
```
```{r echo=FALSE, fig.margin=TRUE, fig.cap="Daniel Bernoulli"}
knitr::include_graphics("img/marg_fig.png")
```
...
```{r echo=FALSE, fig.cap="The diminishing value of additional money"}
...
```{r echo=FALSE, fig.margin=TRUE, fig.cap="Blaise Pascal"}
knitr::include_graphics("img/marg_fig.png")
```
```{r echo=FALSE, fig.margin=TRUE, fig.cap="Pierre de Fermat"}
knitr::include_graphics("img/marg_fig.png")
```
