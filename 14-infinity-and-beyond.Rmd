...
ggplot(NULL, aes(c(0, 1))) + 
  stat_function(fun = st_petersburg, geom = "area", n = 1000, fill = rightcolour) +
  stat_function(fun = st_petersburg_overage, geom = "area", n = 1000, fill = rightcolour, alpha = 0.2) +
...
```{r echo=FALSE, fig.margin=TRUE, fig.show="hold", fig.cap="Daniel Bernoulli ($1700$--$1782$)"}
...
ggplot(data) + 
  geom_area(aes(x = x, y = y), fill = rightcolour) +
