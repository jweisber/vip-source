...
```{r fig.cap="The St. Petersburg game"}
...
```{r fig.margin=TRUE, fig.cap="Nicolaus Bernoulli"}
knitr::include_graphics("img/marg_fig.png")
```
```{r fig.margin=TRUE, fig.cap="Daniel Bernoulli"}
knitr::include_graphics("img/marg_fig.png")
```
...
```{r fig.margin=TRUE, fig.cap="Blaise Pascal"}
knitr::include_graphics("img/marg_fig.png")
```
```{r fig.margin=TRUE, fig.cap="Pierre de Fermat"}
knitr::include_graphics("img/marg_fig.png")
```
